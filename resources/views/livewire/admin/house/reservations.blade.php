<div class="mt-4"><!-- Control Bar Desktop -->
    <div class="sm:border-b border-gray-200 sm:pb-5 sm:flex sm:items-center sm:justify-between">
        <h3 class="text-base font-semibold leading-6 text-gray-900">House reservations</h3>
        ...
        <x-modal.dialog wire:model.defer="showEditModal">
            ...
            <x-slot name="content">
                ...
                <x-input.group for="house_id" label="House id" :error="$errors->first('editing.house_id')">
                    <x-input.text wire:model="editing.house_id" id="startdate" placeholder="house id" />
                </x-input.group>
