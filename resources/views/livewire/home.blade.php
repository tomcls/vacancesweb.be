<div class="bg-white"
    ...
    <x-layouts.menu position="absolute" background="bg-black" textColor="text-white"/>
  
    <div class="relative isolate overflow-hidden pt-14">
      <img src="@include('components.icon.preload-image')" data-src="{{$homepage[$lang]['hero1']['image']}}" alt="{{$homepage[$lang]['hero1']['title']}}" class="absolute inset-0 -z-10 sm:h-full w-full object-cover" />
      ...
      <div class="mx-auto max-w-7xl pt-20 pb-5 sm:pb-16  sm:py-48 lg:py-56 ">
        ...
        <div class="hidden pl-2 pt-2 sm:flex flex-row bg-white  relative w-40 text-center font-bold py-1 rounded-t" >
            <x-icon.guide class=" text-pink-500 w-7 h-7"/>
            Suivez le guide
        </div>
                ...
                <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">
                  ...
                  <div class="-ml-4 flex items-center gap-x-4">
                    ...
                    <div class="flex gap-x-2.5">
                      <img src="@include('components.icon.preload-image')" data-src="{{$homepage[$lang]['post5']['author']['avatar'] ?? ''}}" alt="" class="h-6 w-6 flex-none rounded-full bg-white/10">
                      {{$homepage[$lang]['post5']['author']['name'] ?? ''}}
                    </div>
                  </div>
                </div>
