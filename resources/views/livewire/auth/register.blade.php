...
<form wire:submit.prevent="register" action="#" method="POST">
    ...
    <div class="mt-1 rounded-md shadow-sm">
        <input wire:model="firstname" id="firstname" type="firstname" required class="@error('firstname') border-red-500 @enderror appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
    </div>
    ...
    <div class="mt-1 rounded-md shadow-sm">
        <input wire:model="lastname" id="lastname" type="lastname" required class="@error('lastname') border-red-500 @enderror appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
    </div>
