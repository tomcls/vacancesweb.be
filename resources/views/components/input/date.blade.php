...
>
    <span class="inline-flex items-center px-1 sm:px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm">
    ...
    <input
        ...
        x-ref="input"
        x-bind:value="value"
        class="rounded-none rounded-r-md flex-1 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 border-gray-300
        focus:ring-2 
        focus:ring-inset 
        focus:ring-sky-500 "
    />
