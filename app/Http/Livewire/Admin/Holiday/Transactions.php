...
class Transactions extends Component
{
    ...
    {
        //$this->editing->reference = $this->editing->holiday_id;
        $this->editing->type = InvoiceTransactionTypeEnum::HolidayPurchase;
        $this->validate();
    ...
    public function setAutoCompleteItem($type,$text, $id)
    {
        ...
        switch ($type) {
            case 'editing.reference':
                $holiday = HolidayTitle::whereHolidayId($id)->whereLang(App::currentLocale())->first();
                $this->editing->reference = $id;
    ...
    {
        return view('livewire.admin.holiday.transactions', [
