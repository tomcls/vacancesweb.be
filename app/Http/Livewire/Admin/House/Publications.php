...
class Publications extends Component
{
    ...
    public function mount()
    {
        ...
        $this->housePublications = HousePublication::orderBy('id','desc')->limit(30)->get();
    }
    ...
    public function save()
    {
        ...
        if ($this->createInvoice) {
            $invoice = new Invoice([
                'user_id'=>House::whereId($this->editing->house_id)->first()->user_id,
    ...
    {
        return view('livewire.admin.house.publications', [
